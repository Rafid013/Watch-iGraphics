...
iSetColor(255, 0, 0);
iText(500 + 254, 360 - 150, "4");//4(500+259,360-150)point
...
iSetColor(255, 255, 255);
iText(10, 10, "Press a (or A) For Analog Watch, d (or D) For Digital Watch, end to EXIT");
